...
function componentReloadProps( self, props, defaultState, defaultCallback, complete = false )
{
	...
	if( update.emitter ) {
		update.emitter = Emitter.create(update.emitter);
		if( isEmit ) {
...
export {
	intents, dimensions, htmlBlockNames, mergeClassName, filterProps, appendChild, assignOnly, assignNot, blur, componentProto, componentReloadProps
}